...
test("serves a safe public landing page", async (t) => {
  ...
  assert.match(page, /oss\.520skx\.com\/latest\/LuodongChat-1\.10-win-x64-setup\.exe/);
  assert.match(page, /oss\.520skx\.com\/latest\/LuodongChat-1\.10-win-x64-portable\.zip/);
  assert.match(page, /oss\.520skx\.com\/latest\/LuodongChat-1\.10-android\.apk/);
