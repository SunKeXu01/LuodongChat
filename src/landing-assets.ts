...
export function landingPage(userAgent = ""): string {
  ...
  const primary = isAndroid
    ? { label: "下载 Android 版", meta: "v1.7 · Android 10+ · 约 2.4 MB", href: "https://oss.520skx.com/latest/LuodongChat.apk", file: "LuodongChat.apk", platform: "android" as const }
    : { label: "下载 Windows 版", meta: "v1.7 · Windows 10/11 x64 · 约 58 MB", href: "https://oss.520skx.com/latest/LuodongChat-Setup.exe", file: "LuodongChat-Setup.exe", platform: "windows" as const };
...
<body>
  <main class="page-shell">
    ...
    <footer class="footer"><nav><a href="https://github.com/SunKeXu01/LuodongChat/blob/main/docs/DATA_MODEL.md">隐私说明</a><a href="https://github.com/SunKeXu01/LuodongChat#Windows-使用方式">安装帮助</a><a href="https://github.com/SunKeXu01/LuodongChat/releases/latest">更新记录</a><a href="https://github.com/SunKeXu01/LuodongChat/issues">联系我们</a></nav><span>v1.7 · 服务正常 <i class="status-dot"></i></span></footer>
  </main>
