...
export function landingPage(userAgent = ""): string {
  ...
  const primary = isAndroid
    ...
    : { label: "下载 Windows 版", meta: "v1.17 · Windows 10/11 x64 · 约 62 MB", href: "https://oss.520skx.com/latest/LuodongChat-1.17-win-x64-setup.exe", file: "LuodongChat-1.17-win-x64-setup.exe", platform: "windows" as const };
  const secondary = isAndroid
    ? { label: "Windows 版", href: "https://oss.520skx.com/latest/LuodongChat-1.17-win-x64-setup.exe", file: "LuodongChat-1.17-win-x64-setup.exe", platform: "windows" as const }
  ...
  <main class="page-shell">
    ...
    <section class="hero">
      <div class="hero-copy">
        ...
        <div class="quick-links"><a href="https://oss.520skx.com/latest/LuodongChat-1.17-win-x64-portable.zip">便携版</a><span>·</span><a href="https://github.com/SunKeXu01/LuodongChat/releases/latest">历史版本</a><span class="download-feedback" aria-live="polite"></span></div>
    ...
    <section class="download-details" id="downloads">
      ...
      <div class="download-links"><a href="https://oss.520skx.com/latest/LuodongChat-1.17-win-x64-setup.exe" data-download data-file="LuodongChat-1.17-win-x64-setup.exe">Windows 安装版</a><a href="https://oss.520skx.com/latest/LuodongChat-1.17-win-x64-portable.zip" data-download data-file="LuodongChat-1.17-win-x64-portable.zip">Windows 便携版</a><a href="https://oss.520skx.com/latest/LuodongChat.apk" data-download data-file="LuodongChat.apk">Android 稳定版</a><a href="https://oss.520skx.com/latest/LuodongChat-1.17-win-x64-setup.exe.sha256">SHA-256 校验</a></div>
    </section>
    ...
    <footer class="footer"><nav><a href="https://github.com/SunKeXu01/LuodongChat/blob/main/docs/DATA_MODEL.md">隐私说明</a><a href="https://github.com/SunKeXu01/LuodongChat#Windows-使用方式">安装帮助</a><a href="https://github.com/SunKeXu01/LuodongChat/releases/latest">更新记录</a><a href="https://github.com/SunKeXu01/LuodongChat/issues">联系我们</a></nav><span>v1.17 · 服务正常 <i class="status-dot"></i></span></footer>
  </main>
