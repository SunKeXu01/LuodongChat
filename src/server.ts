...
<body><main><h1>泺栋chat</h1><div class="status"><span class="dot"></span>服务运行正常</div><p>独立的 GPT-5.6 对话客户端。使用邮箱账号登录，无需安装官方 ChatGPT，也无需配置 API 密钥。</p><div class="downloads"><a class="download" href="https://luodongchat-app.oss-cn-beijing.aliyuncs.com/latest/LuodongChat-Setup.exe">下载最新版 Windows 安装包 <span>→</span></a><a class="download secondary" href="https://oss.520skx.com/latest/LuodongChat.apk">下载最新版 Android APK <span>→</span></a><a class="download secondary" href="https://github.com/SunKeXu01/LuodongChat/releases/latest">查看 GitHub Releases <span>→</span></a></div><div class="meta">Windows · Android · 对话仅存本机</div></main></body>
</html>`;
