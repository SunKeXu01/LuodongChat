...
GitHub Release 文件均包含版本号，例如 `LuodongChat-1.6.1-win-x64-setup.exe`、`LuodongChat-1.6.1-win-x64-portable.zip` 与 `LuodongChat-1.6.1-android.apk`，并同时提供 SHA-256 校验文件。OSS 同步存储 Windows 与 Android 最新版且不积累旧安装包；Android 对外下载暂由 GitHub Release 提供。
