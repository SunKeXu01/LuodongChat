...
- Codex 风格对话附件：支持多选、拖拽和剪贴板粘贴图片，图片、PDF、Office、文本和代码文件可与文字一起发送给 GPT 分析
...
7. 点击输入框左下角回形针可一次选择多个附件，也可把文件拖入输入框，或在输入框聚焦时按 Ctrl+V 粘贴截图。单个文件最大 20 MB，每条消息最多 10 个；服务器临时附件 30 分钟后自动删除，已发送附件仅随本地对话保存在当前安装目录。
